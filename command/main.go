...
import (
	...
	"github.com/jiangjiali/vault/sdk/helper/fatih/color"
	"github.com/jiangjiali/vault/sdk/helper/mattn/colorable"
...
func groupedHelpFunc() cli.HelpFunc {
	return func(commands map[string]cli.CommandFactory) string {
		var b bytes.Buffer
		tw := tabwriter.NewWriter(&b, 0, 2, 6, ' ', 0)

		fmt.Fprintf(tw, "使用: vault <命令> [参数]\n\n")
		fmt.Fprintf(tw, "普通命令:\n")
