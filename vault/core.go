...
import (
	...
	"github.com/jiangjiali/vault/sdk/helper/cache"
	...
	"github.com/jiangjiali/vault/sdk/helper/certutil"
	...
	"github.com/jiangjiali/vault/sdk/helper/tlsutil"
	"github.com/jiangjiali/vault/sdk/logical"
	"github.com/jiangjiali/vault/sdk/physical"
	"github.com/jiangjiali/vault/shamir"
...
type Core struct {
	...
	// publicBackend is the backend which manages the per-token storage
...
func NewCore(conf *CoreConfig) (*Core, error) {
	...
	logicalBackends["public"] = PublicBackendFactory
