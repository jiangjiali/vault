...
import (
	...
	"github.com/jiangjiali/vault/sdk/helper/cleanhttp"
	...
	"github.com/jiangjiali/vault/sdk/helper/pathmanager"
...
func Handler(props *vault.HandlerProperties) http.Handler {
	...
	if core.UIEnabled() == true { //主页路由
		mux.Handle("/", handleUIHeaders(core, handleUIStub()))
	}
