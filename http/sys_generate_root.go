...
func handleSysGenerateRootAttempt(core *vault.Core, generateStrategy vault.GenerateRootStrategy) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.Method {
		case "GET":
			handleSysGenerateRootAttemptGet(core, w, "")
		case "POST", "PUT":
			handleSysGenerateRootAttemptPut(core, w, r, generateStrategy)
		case "DELETE":
			handleSysGenerateRootAttemptDelete(core, w)
		default:
...
func handleSysGenerateRootAttemptGet(core *vault.Core, w http.ResponseWriter, otp string) {
...
func handleSysGenerateRootAttemptPut(core *vault.Core, w http.ResponseWriter, r *http.Request, generateStrategy vault.GenerateRootStrategy) {
	...
	if genned {
		handleSysGenerateRootAttemptGet(core, w, req.OTP)
		return
	}
...
func handleSysGenerateRootAttemptDelete(core *vault.Core, w http.ResponseWriter) {
