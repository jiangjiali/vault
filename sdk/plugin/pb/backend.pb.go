...
import (
	fmt "fmt"
	logical "github.com/jiangjiali/vault/sdk/logical"
...
type TokenEntry struct {
	...
	PublicID          string            `sentinel:"" protobuf:"bytes,17,opt,name=public_id,json=publicId,proto3" json:"public_id,omitempty"`
...
func (m *TokenEntry) GetPublicID() string {
	if m != nil {
		return m.PublicID
	}
	return ""
