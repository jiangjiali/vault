...
var _ physical.Backend = (*FBackend)(nil)
var _ physical.Transactional = (*TransactionalFileBackend)(nil)
var _ physical.PseudoTransactional = (*FBackend)(nil)
...
func (b *FBackend) cleanupLogicalPath(path string) error {
...
func (b *FBackend) expandPath(k string) (string, string) {
...
func (b *FBackend) validatePath(path string) error {
	switch {
