...
import (
	...
	"github.com/jiangjiali/vault/sdk/helper/prometheus/procfs/internal/fs"
	"github.com/jiangjiali/vault/sdk/helper/prometheus/procfs/internal/util"
)
...
func (p Proc) CmdLine() ([]string, error) {
	...
	return strings.Split(string(bytes.TrimRight(data, "\x00")), string(byte(0))), nil
}
